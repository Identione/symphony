...
4. Check mergeability and conflicts against the PR's base branch.
5. If conflicts exist, use the `pull` skill to fetch/merge the base branch (it
   resolves `git config symphony.baseBranch`, defaulting to `origin/main`) and
